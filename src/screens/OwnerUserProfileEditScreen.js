...
const OwnerUserProfileEditScreen = ({ navigation }) => {
  const [name, setName] = useState('John Doe');
  const [address, setAddress] = useState('123 Main St, City, Country');
  const [email, setEmail] = useState('johndoe@example.com');
  const [contactNumber, setContactNumber] = useState('123-456-7890');
  const [profilePic, setProfilePic] = useState(require('../../assets/images/Owner.png'));
...
export default OwnerUserProfileEditScreen;
