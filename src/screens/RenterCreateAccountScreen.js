// screens/RenterCreateAccountScreen.js
...
const RenterCreateAccountScreen = ({ navigation }) => {
              ...
              tx.executeSql(
                ...
                (_, result) => {
                  if (result.rowsAffected > 0) {
                    ...
                    console.log('Creating renter account:', fullName, email, password);
                    // After successful account creation, you can navigate to the next screen
                    navigation.navigate('RenterDashboardScreen'); // Replace with the actual dashboard screen for renters
                  } else {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Create Renter Account</Text>
      <TextInput
        style={styles.input}
...
export default RenterCreateAccountScreen;
